...
export default function Council(){
    return(
        <div className="overflow-hidden flex flex-row max-[950px]:flex-col pt-20">
            ...
            <div className="overflow-hidden w-[60%] max-[950px]:w-[100%] p-2">
                <div className="p-5 mb-1 flex max-[450px]:flex-col">
                    ...
                    <div className="w-[40vw] max-[450px]:w-[85vw] max-[950px]:w-[70vw] max-[950px]:min-h-[15vh] h-auto min-h-[20vh] rounded-xl bg-gradient-to-r from-orange-600 via-orange-500 to-orange-400 overflow-hidden p-1">
                        <p className="text-white font-bold font-serif text-xl pt-2 pl-4">Academic Council</p>
                        <p className="text-white font-light text-sm mt-1 pb-2 pl-4">AnC Council has been trusted with the responsibility of managing executive activities in two of the most crucial aspects of student life - Academics and Career.</p>
                        </div>
                    </div>
                    ...
                    <div className="w-[40vw] max-[450px]:w-[85vw] max-[950px]:w-[70vw] max-[950px]:min-h-[15vh] h-auto min-h-[20vh] rounded-xl bg-gradient-to-r from-orange-600 via-orange-500 to-orange-400 overflow-hidden">
                        <p className="text-white font-bold font-serif text-xl pt-2 pl-4">Cultural Council</p>
                        <p className="text-white font-light text-sm mt-1 pb-2 pl-4">The Cultural Council of IIT Indore orchestrates a diverse array of cultural events throughout the year, fostering artistic expression and community engagement among students and faculty alike.</p>
                        </div>
                    </div>
                    <div className="p-5 mb-1 flex max-[450px]:flex-col">
                    <div className="min-w-[120px] max-[450px]:mb-3 max-[550px]:w-[5vw] max-[550px]:min-w-[80px] max-[550px]:max-h-[11vh] w-[8vw] max-h-[16vh] text-center items-center rounded-full mr-1 bg-black">
                    ...
                    <p className="text-white font-bold font-serif text-xl pt-2 pl-4">Science and Technology Council</p>
                        <p className="text-white font-light text-sm mt-1 pb-2 pl-4">The SnT Council of IIT Indore is a community of science and technology enthusiasts who love to explore the unthinkable.</p>
                        </div>
                    </div>
                    ...
                    <p className="text-white font-bold font-serif text-xl pt-2 pl-4">Sports Council</p>
                        <p className="text-white font-light text-sm mt-1 pb-2 pl-4">GnS Council is the voice and face of IIT Indore sports community, responsible for management and conduction of all sporting events in the campus.</p>
                        </div>
                    </div>
            </div>
        </div>
