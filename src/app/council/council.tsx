    ...
    return(
        <div className="overflow-hidden flex flex-row max-[950px]:flex-col py-20 bg-[url(/bg7.jpg)] bg-cover bg-center">
            ...
            <div className="overflow-hidden w-[60%] max-[950px]:w-[100%] p-2">
                    ...
                    <div className="w-[40vw] max-[450px]:w-[85vw] max-[950px]:w-[70vw] max-[950px]:min-h-[15vh] h-auto min-h-[16vh] rounded-xl bg-gradient-to-r from-yellow-500 via-yellow-500 to-yellow-400 overflow-hidden">
                    ...
                    <p className="text-white font-bold font-serif text-xl pt-2 pl-4">Sports Council</p>
                        <p className="text-white font-light text-sm mt-1  pl-4">GnS Council is the voice and face of IIT Indore sports community, responsible for management and conduction of all sporting events in the campus.</p>
                        </div>
                    </div>
                    <div className="p-5 mb-1 flex max-[450px]:flex-col">
                    <div className="min-w-[120px] max-[450px]:mb-3 max-[550px]:w-[5vw] max-[550px]:min-w-[80px] max-[550px]:max-h-[11vh] w-[8vw] max-h-[16vh] text-center items-center rounded-full mr-1 bg-black">
                    ...
                    <div className="w-[40vw] max-[450px]:w-[85vw] max-[950px]:w-[70vw] max-[950px]:min-h-[15vh] h-auto min-h-[16vh] rounded-xl bg-gradient-to-r from-yellow-500 via-yellow-500 to-yellow-400 overflow-hidden p-1">
                        <p className="text-white font-bold font-serif text-xl pt-2 pl-4">Academic Council</p>
                        <p className="text-white font-light text-sm mt-1  pl-4">AnC Council has been trusted with the responsibility of managing executive activities in two of the most crucial aspects of student life - Academics and Career.</p>
                        </div>
                    </div>
            </div>
